package com.techacademy.controllers;
...
import com.techacademy.beans.SessionControl;
import com.techacademy.dtos.LoginForm;
import com.techacademy.dtos.SignupForm;
...
public class UserController {
    ...
    public ModelAndView signup(@ModelAttribute("signupForm") SignupForm signupForm, ModelAndView mav) throws IOException{
        User exisitingUser = this.userRepository.findByEmail(signupForm.getMailAddress());
